...
const cookieDeclarationScript = '<script id="CookieDeclaration" src="https://consent.cookiebot.com/9c89554a-d41d-4a9b-ac12-e107a356b018/cd.js" type="text/javascript" async></script>'
...
const Datenschutz = () => (
  <>
    ...
    <p>&nbsp;</p>
    <p>
      Sie k&ouml;nnen unsere Webseiten besuchen, ohne Angaben zu Ihrer Person zu
    ...
    <p>
      ...
      Drittanbieter f&uuml;r uns die Dienste zum Hosting und zur Darstellung der
      Webseite. Alle Daten, die im Rahmen der Nutzung dieser Webseite oder in
      daf&uuml;r vorgesehenen Formularen im Onlineshop wie folgend beschrieben
      erhoben werden, werden auf seinen Servern verarbeitet. Eine Verarbeitung
      auf anderen Servern findet nur in dem hier erl&auml;uterten Rahmen statt.
    </p>
    <p>
    ...
    <p>
      ...
      Daten f&uuml;r die weitere Verarbeitung eingeschr&auml;nkt und nach Ablauf
      etwaiger steuer- und handelsrechtlichen Aufbewahrungsfristen
      gel&ouml;scht, sofern Sie nicht ausdr&uuml;cklich in eine weitere Nutzung
      Ihrer Daten eingewilligt haben oder wir uns eine dar&uuml;ber
    ...
    <p>
      ...
      welchen Zahlungsdienstleister Sie im Bestellprozess ausw&auml;hlen, geben
      wir zur Abwicklung von Zahlungen die hierf&uuml;r erhobenen Zahlungsdaten
      an das mit der Zahlung beauftragte Kreditinstitut und ggf. von uns
      beauftragte Zahlungsdienstleister weiter bzw. an den ausgew&auml;hlten
      Zahlungsdienst. Zum Teil erheben die ausgew&auml;hlten
      ...
      Datenschutzerkl&auml;rung des jeweiligen Zahlungsdienstleisters.
    </p>
    <p>&nbsp;&nbsp;</p>
    <p>&nbsp;</p>
    <p>
    ...
    <p>
      ...
      bestimmter Funktionen zu erm&ouml;glichen, um passende Produkte anzuzeigen
      ...
      Abs. 1 S. 1 lit. f DSGVO. Cookies sind kleine Textdateien, die automatisch
      auf Ihrem Endger&auml;t gespeichert werden. Einige der von uns verwendeten
      Cookies werden nach Ende der Browser-Sitzung, also nach Schlie&szlig;en
      Ihres Browsers, wieder gel&ouml;scht (sog. Sitzungs-Cookies). Andere
      Cookies verbleiben auf Ihrem Endger&auml;t und erm&ouml;glichen uns, Ihren
      Browser beim n&auml;chsten Besuch wiederzuerkennen (persistente Cookies).
      Die Dauer der Speicherung k&ouml;nnen Sie der &Uuml;bersicht in den
      ...
      informiert werden und einzeln &uuml;ber deren Annahme entscheiden oder die
      ...
      die Cookie-Einstellungen verwaltet. Diese ist in dem Hilfemen&uuml; jedes
    ...
    <p>
      ...
      informieren dort &uuml;ber unsere Produkte und laufende Sonderaktionen.
      ...
      automatisch erhoben und gespeichert werden. Aus diesen Daten werden unter
      Verwendung von Pseudonymen sog. Nutzungsprofile erstellt. Diese
      ...
      Hilfe einer Checkbox, ist die Rechtsgrundlage der Datenverarbeitung Art. 6
      Abs. 1 lit. a DSGVO.
      <br /> Soweit die vorgenannten Social-Media Plattformen ihren Hauptsitz in
      den USA haben, gilt Folgendes: F&uuml;r die USA liegt ein
      Angemessenheitsbeschluss der Europ&auml;ischen Kommission vor. Dieser geht
      zur&uuml;ck auf den EU-US Privacy Shield. Ein aktuelles Zertifikat
      ...
      insbesondere Widerspruchsm&ouml;glichkeiten (Opt-Out), entnehmen Sie bitte
      den unten verlinkten Datenschutzhinweisen der Anbieter. Sollten Sie
      diesbez&uuml;glich dennoch Hilfe ben&ouml;tigen, k&ouml;nnen Sie sich an
      uns wenden.
    </p>
    <p>
      Facebook:{" "}
    ...
    <ul>
      ...
      <li>
        gem&auml;&szlig; Art. 20 DSGVO das Recht, Ihre personenbezogenen Daten,
        die Sie uns bereitgestellt haben, in einem strukturierten, g&auml;ngigen
        und maschinenlesebaren Format zu erhalten oder die &Uuml;bermittlung an
    ...
    <p>
      ...
      Daten, bei Ausk&uuml;nften, Berichtigung, Einschr&auml;nkung oder
      L&ouml;schung von Daten sowie Widerruf erteilter Einwilligungen oder
      Widerspruch gegen eine bestimmte Datenverwendung wenden Sie sich bitte
      direkt an uns &uuml;ber die Kontaktdaten in unserem Impressum.
    </p>
        ...
        <tr>
          <td>
            <p>
              ...
              Widerspruchsrecht nur bei Vorliegen von Gr&uuml;nden, die sich aus
